export const WormholeTransceiverAbi = [
  {
    inputs: [
      ...
      { internalType: "address", name: "wormholeCoreBridge", type: "address" },
      { internalType: "address", name: "wormholeRelayerAddr", type: "address" },
      { internalType: "address", name: "specialRelayerAddr", type: "address" },
      { internalType: "uint8", name: "_consistencyLevel", type: "uint8" },
  ...
  {
    inputs: [{ internalType: "address", name: "currentOwner", type: "address" }],
  ...
  {
    inputs: [{ internalType: "BooleanFlag", name: "value", type: "uint256" }],
  ...
  { inputs: [], name: "InvalidWormholeChainIdZero", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "InvalidWormholePeerZeroAddress", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "encodedLength", type: "uint256" },
  ...
  {
    inputs: [{ internalType: "bytes32", name: "vaaHash", type: "bytes32" }],
    name: "TransferAlreadyCompleted",
    type: "error",
  },
  { inputs: [], name: "UnexpectedAdditionalMessages", type: "error" },
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "isEvm", type: "bool" },
    ],
  ...
  },
  {
    inputs: [
      {
        components: [{ internalType: "bool", name: "shouldSkipRelayerSend", type: "bool" }],
  ...
  {
    inputs: [{ internalType: "bytes", name: "encodedMessage", type: "bytes" }],
    name: "receiveMessage",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [
      { internalType: "bytes", name: "payload", type: "bytes" },
      { internalType: "bytes[]", name: "additionalMessages", type: "bytes[]" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes", name: "nttManagerMessage", type: "bytes" },
      {
        internalType: "bytes32",
        name: "recipientNttManagerAddress",
        type: "bytes32",
  ...
  },
  {
    inputs: [
      { internalType: "uint16", name: "chainId", type: "uint16" },
      { internalType: "bool", name: "isEvm", type: "bool" },
    ],
    name: "setIsWormholeEvmChain",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [],
    name: "specialRelayer",
    outputs: [{ internalType: "contract ISpecialRelayer", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
