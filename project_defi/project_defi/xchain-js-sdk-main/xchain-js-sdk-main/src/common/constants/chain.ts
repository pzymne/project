...
export const FOLKS_CHAIN: Record<NetworkType, Partial<Record<FolksChainId, FolksChain>>> = {
  [NetworkType.MAINNET]: {
    ...
    [FOLKS_CHAIN_ID.MONAD]: {
      chainType: ChainType.EVM,
      folksChainId: FOLKS_CHAIN_ID.MONAD,
    ...
    [FOLKS_CHAIN_ID.AVALANCHE]: {
      ...
      tokens: {
        ...
        [MAINNET_FOLKS_TOKEN_ID.SHIB]: {
          ...
          spokeAddress: convertToGenericAddress(
            "0x93FD598238377BDcad1712B7FeDA421a02527d7B" as EvmAddress,
            ChainType.EVM,
          ),
        },
      ...
      tokens: {
        ...
        [MAINNET_FOLKS_TOKEN_ID.SHIB]: {
          token: {
            type: TokenType.CROSS_CHAIN,
            adapters: [AdapterType.CCIP_TOKEN],
            address: convertToGenericAddress("0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE" as EvmAddress, ChainType.EVM),
            decimals: 18,
          },
          folksTokenId: MAINNET_FOLKS_TOKEN_ID.SHIB,
          poolId: MAINNET_POOLS[MAINNET_FOLKS_TOKEN_ID.SHIB],
          spokeAddress: convertToGenericAddress(
            "0xB7AB35580A6F609B8e9f9CFa28B4A4E9464D7884" as EvmAddress,
            ChainType.EVM,
          ),
        },
      ...
      tokens: {
        ...
        [MAINNET_FOLKS_TOKEN_ID.SHIB]: {
          token: {
            type: TokenType.CROSS_CHAIN,
            adapters: [AdapterType.CCIP_TOKEN],
            address: convertToGenericAddress("0x9Ded28d9EC69F97efd718CE768dc39D78fd014F8" as EvmAddress, ChainType.EVM),
            decimals: 18,
          },
          folksTokenId: MAINNET_FOLKS_TOKEN_ID.SHIB,
          poolId: MAINNET_POOLS[MAINNET_FOLKS_TOKEN_ID.SHIB],
          spokeAddress: convertToGenericAddress(
            "0x3eF10e94B4309415ebd8c1680CA3a5eE5Df9aCD7" as EvmAddress,
            ChainType.EVM,
          ),
        },
      ...
      tokens: {
        ...
        [MAINNET_FOLKS_TOKEN_ID.SHIB]: {
          token: {
            type: TokenType.CROSS_CHAIN,
            adapters: [AdapterType.CCIP_TOKEN],
            address: convertToGenericAddress("0xEc59dE82FFf1959E92b91daB975e4564FC3447cC" as EvmAddress, ChainType.EVM),
            decimals: 18,
          },
          folksTokenId: MAINNET_FOLKS_TOKEN_ID.SHIB,
          poolId: MAINNET_POOLS[MAINNET_FOLKS_TOKEN_ID.SHIB],
      ...
      tokens: {
        ...
        [MAINNET_FOLKS_TOKEN_ID.SHIB]: {
          token: {
            type: TokenType.CROSS_CHAIN,
            adapters: [AdapterType.CCIP_TOKEN],
            address: convertToGenericAddress("0xB359155378FF5E2837f12ed0bee5168123c88ACC" as EvmAddress, ChainType.EVM),
            decimals: 18,
          },
          folksTokenId: MAINNET_FOLKS_TOKEN_ID.SHIB,
          poolId: MAINNET_POOLS[MAINNET_FOLKS_TOKEN_ID.SHIB],
    ...
    [FOLKS_CHAIN_ID.MONAD]: {
      ...
      tokens: {
        ...
        [MAINNET_FOLKS_TOKEN_ID.gMON]: {
          token: {
            type: TokenType.ERC20,
            address: convertToGenericAddress("0x8498312A6B3CbD158bf0c93AbdCF29E6e4F55081" as EvmAddress, ChainType.EVM),
            decimals: 18,
          },
          folksTokenId: MAINNET_FOLKS_TOKEN_ID.gMON,
          poolId: MAINNET_POOLS[MAINNET_FOLKS_TOKEN_ID.gMON],
          spokeAddress: convertToGenericAddress(
            "0x9105CEEbaf43EF6B80dF1b66BEfFd5F98A036c36" as EvmAddress,
            ChainType.EVM,
          ),
        },
        [MAINNET_FOLKS_TOKEN_ID.shMON]: {
          token: {
            type: TokenType.ERC20,
            address: convertToGenericAddress("0x1B68626dCa36c7fE922fD2d55E4f631d962dE19c" as EvmAddress, ChainType.EVM),
            decimals: 18,
          },
          ...
          tokens: {
            [MAINNET_REWARDS_TOKEN_ID.FOLKS_mon]: {
              ...
              token: {
                type: TokenType.ERC20,
                address: convertToGenericAddress(
                  "0xFF7F8F301F7A706E3CfD3D2275f5dc0b9EE8009B" as EvmAddress,
                  ChainType.EVM,
                ),
                decimals: 6,
              },
  ...
  [NetworkType.TESTNET]: {
    ...
    [FOLKS_CHAIN_ID.ETHEREUM_SEPOLIA]: {
      ...
      adapters: {
        ...
        [AdapterType.WORMHOLE_EXECUTOR_DATA]: convertToGenericAddress(
          "0xFA9947D79c38A3f1927e42cecfedE4EFB77cD6A7" as EvmAddress,
          ChainType.EVM,
        ),
      },
      tokens: {
      ...
      rewards: {
        ...
        adapters: {
          ...
          [AdapterType.WORMHOLE_EXECUTOR_DATA]: convertToGenericAddress(
            "0x2d415475bb24A61ac7931988A918320F209AcfBe" as EvmAddress,
            ChainType.EVM,
          ),
        },
        [REWARDS_TYPE.V2]: {
    ...
    [FOLKS_CHAIN_ID.BASE_SEPOLIA]: {
      ...
      adapters: {
        ...
        [AdapterType.WORMHOLE_EXECUTOR_DATA]: convertToGenericAddress(
          "0x02392a9897e774D50B674c03462eDcaf84Bb974e" as EvmAddress,
          ChainType.EVM,
        ),
      },
      tokens: {
      ...
      rewards: {
        ...
        adapters: {
          ...
          [AdapterType.WORMHOLE_EXECUTOR_DATA]: convertToGenericAddress(
            "0x99f7Be8d1da67eB575c3A5B769ed2050417420a4" as EvmAddress,
            ChainType.EVM,
          ),
        },
        [REWARDS_TYPE.V2]: {
    ...
    [FOLKS_CHAIN_ID.ARBITRUM_SEPOLIA]: {
      ...
      adapters: {
        ...
        [AdapterType.WORMHOLE_EXECUTOR_DATA]: convertToGenericAddress(
          "0x969a3eC1fA34C929201cB1B5F07863f8b190eD60" as EvmAddress,
          ChainType.EVM,
        ),
      },
      tokens: {
    ...
    [FOLKS_CHAIN_ID.SEI_TESTNET]: {
      ...
      rewards: {
        ...
        adapters: {
          ...
          [AdapterType.WORMHOLE_EXECUTOR_DATA]: convertToGenericAddress(
            "0x06D5BF5ef5cbcE9113049E0D7Fe3bE34eF7055c1" as EvmAddress,
            ChainType.EVM,
          ),
        },
        [REWARDS_TYPE.V2]: {
