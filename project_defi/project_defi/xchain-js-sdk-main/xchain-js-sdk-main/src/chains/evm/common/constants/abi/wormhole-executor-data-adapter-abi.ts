export const WormholeExecutorDataAdapterAbi = [
  {
    inputs: [
      {
      ...
      {
        internalType: "contract ICoreBridge",
        name: "_wormhole",
        type: "address",
      },
      {
        internalType: "contract IExecutorQuoterRouter",
        name: "_executorQuoterRouter",
        type: "address",
      },
      {
