export const NttManagerAbi = [
  {
    inputs: [
      ...
      { internalType: "enum IManagerBase.Mode", name: "_mode", type: "uint8" },
      { internalType: "uint16", name: "_chainId", type: "uint16" },
      { internalType: "uint64", name: "_rateLimitDuration", type: "uint64" },
      { internalType: "bool", name: "_skipRateLimiting", type: "bool" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "balanceDiff", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "canceller", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "TrimmedAmount", name: "newLimit", type: "uint72" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "providedPayment", type: "uint256" },
    ],
    name: "DeliveryPaymentTooLow",
    type: "error",
  },
  {
    inputs: [{ internalType: "address", name: "transceiver", type: "address" }],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "transferTimestamp", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "peerAddress", type: "bytes32" },
    ],
    name: "InvalidPeer",
    type: "error",
  },
  { inputs: [], name: "InvalidPeerChainIdZero", type: "error" },
  { inputs: [], name: "InvalidPeerDecimals", type: "error" },
  { inputs: [], name: "InvalidPeerSameChainId", type: "error" },
  { inputs: [], name: "InvalidPeerZeroAddress", type: "error" },
  { inputs: [], name: "InvalidRecipient", type: "error" },
  { inputs: [], name: "InvalidRefundAddress", type: "error" },
  {
    inputs: [
      { internalType: "uint16", name: "targetChain", type: "uint16" },
      { internalType: "uint16", name: "thisChain", type: "uint16" },
    ],
    name: "InvalidTargetChain",
    type: "error",
  },
  { inputs: [], name: "InvalidTransceiverZeroAddress", type: "error" },
  {
    inputs: [{ internalType: "bytes32", name: "msgHash", type: "bytes32" }],
    name: "MessageNotApproved",
    type: "error",
  },
  { inputs: [], name: "NoEnabledTransceivers", type: "error" },
  {
    inputs: [{ internalType: "address", name: "transceiver", type: "address" }],
  ...
  { inputs: [], name: "NotMigrating", type: "error" },
  {
    inputs: [
      { internalType: "uint8", name: "decimals", type: "uint8" },
      { internalType: "uint8", name: "decimalsOther", type: "uint8" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint64", name: "queueSequence", type: "uint64" },
      { internalType: "uint256", name: "transferTimestamp", type: "uint256" },
    ],
  ...
  { inputs: [], name: "RequireContractIsNotPaused", type: "error" },
  { inputs: [], name: "RequireContractIsPaused", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "retrieved", type: "uint256" },
      { internalType: "uint256", name: "registered", type: "uint256" },
    ],
    name: "RetrievedIncorrectRegisteredTransceivers",
    type: "error",
  },
  { inputs: [], name: "StaticcallFailed", type: "error" },
  {
    inputs: [
      { internalType: "uint256", name: "threshold", type: "uint256" },
      { internalType: "uint256", name: "transceivers", type: "uint256" },
    ],
    name: "ThresholdTooHigh",
    type: "error",
  },
  { inputs: [], name: "TooManyTransceivers", type: "error" },
  {
    inputs: [
      {
  ...
  { inputs: [], name: "UndefinedRateLimiting", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "UnexpectedMsgValue", type: "error" },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "bool", name: "notPaused", type: "bool" }],
    name: "NotPaused",
    type: "event",
  },
  {
  ...
  {
    inputs: [{ internalType: "uint64", name: "messageSequence", type: "uint64" }],
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "TrimmedAmount", name: "limit", type: "uint72" },
          {
            internalType: "TrimmedAmount",
            name: "currentCapacity",
            type: "uint72",
          },
          { internalType: "uint64", name: "lastTxTimestamp", type: "uint64" },
        ],
  ...
  },
  {
    inputs: [],
    name: "mode",
    outputs: [{ internalType: "enum IManagerBase.Mode", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bytes32", name: "recipient", type: "bytes32" },
      { internalType: "bytes32", name: "refundAddress", type: "bytes32" },
      { internalType: "bool", name: "shouldQueue", type: "bool" },
      { internalType: "bytes", name: "transceiverInstructions", type: "bytes" },
    ],
    name: "transfer",
    outputs: [{ internalType: "uint64", name: "", type: "uint64" }],
